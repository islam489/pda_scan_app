...
class _ReceiptScreenState extends State<ReceiptScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocBuilder<GetPurchaseOrderDetailsCubit, GetPurchaseOrderDetailsState>(
                ...
                child: Column(
                  children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  TextButton(
                                    child: Text(
                                      "ترحيل",
                                      style: TextStyles.font16WhiteMedium.copyWith(fontWeight: FontWeight.w700),
                                    ),
                                    style: ButtonStyle(
                                      backgroundColor: MaterialStateProperty.all(ColorsManager.gray),
                                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          BlocBuilder<GetPurchaseOrderDetailsCubit, GetPurchaseOrderDetailsState>(
                            builder: (context, state) {
                              return Expanded(
                                child: Container(
                                  padding: EdgeInsets.all(8),
                                  color: ColorsManager.mainBlue,
                                  child: Text(
                                    context.read<GetPurchaseOrderDetailsCubit>().result?.supplier_nameEn ?? "",
